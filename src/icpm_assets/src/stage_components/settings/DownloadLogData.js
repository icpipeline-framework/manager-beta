...
const DownloadLogData = (props) => {
    ...
    const getICPMConfigDownload = async ()  =>  {
      ...
      let error="";
        ...
        const fetchData = await icpmDapp.getICPMLogDownload(apiToken,sha512(loginCode)).catch(e => { return "ICPM Error: " + e });
        //await sleep(500);
  ...
  const handleClick =  (removePrincipalText) => {
    ...
    const startDownload =  () => {
      ...
      console.log ("localTime: ",localTime) ;
        ...
        element.download = `icpm-logs-${localTime}.json`;
    ...
    if (isLoading) {
      ...
      >
        ...
        <SettingsIcon fontSize="small" sx={{mr:1}}/> Save Log Data
        </Typography>
        <Typography variant="body2" color="text.primary" align="center" sx={{m:1}}>
        (Events, Deployments, Jobs, Canisters)
        </Typography>
      ...
      return( 
        ...
        if (dataFilesResponse.responseStatus == "Green" ) {
          ...
          return (
                ...
                Enter the manager code to create a file with all of the stable var log data in this ICPM.
                </Typography>
