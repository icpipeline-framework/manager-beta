    ...
    if (isLoading) {
      ...
      return ( 
        ...
        <Paper elevation={4}
          ...
          <SettingsIcon fontSize="small" sx={{mr:1}}/> Manage II Principals
          </Typography>
          </Paper>
      ...
      return( 
            ...
            <Paper elevation={4}
              ...
              <Typography variant="h6" color="text.primary" align="center" sx={{m:1}}>
              <SettingsIcon fontSize="small" sx={{mr:1}}/>Manage II Principals
              </Typography>
              </Paper>
        ...
        if (listOfPrincipals.length > 0 ) {
          ...
          return (
                ...
                Enter the manager code to get a list of the existing principals active as managers to this ICPM.
                </Typography>
                
                <Button onClick={() => { handleClick()}}  variant="contained" sx={{ml:2, mr:2}}>Get List of Principals</Button>
